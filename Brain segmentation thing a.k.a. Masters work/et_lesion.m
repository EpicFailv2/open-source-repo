function ratios = et_lesion()
% ET_LESION - automatic lesion detector
%
%   TBA
%
% AB 2016.11.15 "edgetech" All Rights Reserved.

origdir = cd;

srcNiiDir = 'D:\Games\MATLAB R2015a\_et files\Masters\1Semester\testDir\src'; % folder with FMRI scan .nii files (needs L or R at the name end to indicate damaged hamisphere); without '\' at the end; was 'D:\Games\MATLAB R2015a\_et files\Masters\mri_filtered\source'
labelsDir = 'D:\Games\MATLAB R2015a\_et files\Masters\1Semester\testDir\lbl'; % folder with hand drawn lesion areas for patients (name: ['l' patient_nii_file_name] <- that is small L); without '\' at the end; was 'D:\Games\MATLAB R2015a\_et files\Masters\mri_filtered\labels'
wrkDirRoot= 'D:\Games\MATLAB R2015a\_et files\Masters\1Semester\testDir\'; % folder where folders with generated data will be placed; with '\' at the end
pngDir =    'D:\Games\MATLAB R2015a\_et files\Masters\1Semester\testDir\png'; % folder for DSC plot placement; without '\' at the end
